...
public class SetmealServiceImpl implements SetmealService {
    ...
    @Override
    public List<Setmeal> selectByCatId(Long categoryId) {
        return setmealMapper.selectByCatId(categoryId);
    }

    @Override
    public List<DishItemVO> selectDishItemsBySetmealId(Long setmealId) {
